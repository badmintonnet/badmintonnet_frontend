...
import TournamentsTable from "@/app/(admin)/admin/tournaments/_components/tournaments-table";
...
export default async function TournamentsPage({
  ...
  try {
    const response = await adminApiRequest.getAllTournament(
      page,
      size,
      accessToken?.value,
    );
    ...
    const tournaments = response.payload.data.content || [];
    const {
      totalPages,
      page: currentPage,
